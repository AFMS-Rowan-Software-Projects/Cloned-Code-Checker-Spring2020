...
public class ParserTest {
	...
	public void testFindMethod() {
		...
		String tester = cfr.readFile("src/cpp_data/coins.txt");
		...
		while(indicies[0] != -1) {
			...
			if(indicies[0] == -1) {
				...
				System.out.println("between indicies " + indicies[0] + " , " + indicies[1] + "is " + Parser.subarray(List, indicies[0], indicies[1]));
			}
		}
	}
}
